 ...
 *
 * Upstream (Kotlin 2.4.x) introduced this to avoid mapping entire jars into memory at once. On low-end
 * Android devices (Sketchware, ~1 GB free RAM) only the currently-accessed region of a jar is memory mapped,
 * which drastically cuts peak RSS when scanning large classpath jars (android.jar, kotlin-stdlib, etc.).
 *
